...
export default function ExperienceSection() {
  ...
  const experiences: Experience[] = [
    ...
    // },
    {
      ...
      period: "January 2026",
      location: "Mangalore, India",
      description: "Its fun working again as a Fullstack Developer",
      responsibilities: [
        "Developed a Joint Account feature for a mutual fund application",
        "Designed and developed frontend application for a US dermat client",
      ],
      technologies: [
        // { name: "React", icon: "i-logos-react" },
        { name: "Next.js", icon: " i-logos-nextjs-icon" },
    ...
    },
    {
      ...
      description:
        "Built a full-stack web app (Fashion Academy) integrating frontend and backend technologies.",
      responsibilities: [
